	...
	SubShader
	{
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				fixed4 finalColor;
				float3 temp_output_2_0_g716 = (AHF_FogColor).rgb;
				float3 gammaToLinear3_g716 = GammaToLinearSpace( temp_output_2_0_g716 );
				#ifdef UNITY_COLORSPACE_GAMMA
				float3 staticSwitch1_g716 = temp_output_2_0_g716;
				#else
				float3 staticSwitch1_g716 = gammaToLinear3_g716;
				#endif
				float3 temp_output_893_0 = staticSwitch1_g716;
				float3 temp_output_2_0_g715 = (AHF_DirectionalColor).rgb;
				float3 gammaToLinear3_g715 = GammaToLinearSpace( temp_output_2_0_g715 );
				#ifdef UNITY_COLORSPACE_GAMMA
				float3 staticSwitch1_g715 = temp_output_2_0_g715;
				#else
				float3 staticSwitch1_g715 = gammaToLinear3_g715;
				#endif
				...
				float3 normalizeResult5_g710 = normalize( ( WorldPosition144 - _WorldSpaceCameraPos ) );
				float3 ase_worldPos = i.ase_texcoord1.xyz;
				float3 worldSpaceLightDir = Unity_SafeNormalize(UnityWorldSpaceLightDir(ase_worldPos));
				float dotResult6_g710 = dot( normalizeResult5_g710 , worldSpaceLightDir );
				float temp_output_7_0_g711 = -1.0;
				half DirectionalMask134 = ( ( ( dotResult6_g710 - temp_output_7_0_g711 ) / ( 1.0 - temp_output_7_0_g711 ) ) * AHF_DirectionalIntensity * AHF_DirectionalModeBlend );
				float3 lerpResult135 = lerp( temp_output_893_0 , staticSwitch1_g715 , DirectionalMask134);
				...
				float3 staticSwitch241 = temp_output_893_0;
				#endif
				float temp_output_7_0_g697 = AHF_FogDistanceStart;
				half FogDistanceMask186 = saturate( ( ( distance( WorldPosition144 , _WorldSpaceCameraPos ) - temp_output_7_0_g697 ) / ( AHF_FogDistanceEnd - temp_output_7_0_g697 ) ) );
				...
				float simplePerlin3D15_g700 = snoise( ( ( WorldPosition144 * ( 1.0 / AHF_NoiseScale ) ) + ( -AHF_NoiseSpeed * _Time.y ) ) );
				float temp_output_7_0_g703 = -1.0;
				...
				float lerpResult20_g700 = lerp( 1.0 , ( ( simplePerlin3D15_g700 - temp_output_7_0_g703 ) / ( 1.0 - temp_output_7_0_g703 ) ) , ( NoiseDistanceMask353 * AHF_NoiseIntensity * AHF_NoiseModeBlend ));
				half NoiseSimplex3D234 = lerpResult20_g700;
				...
				float staticSwitch242 = temp_output_115_0;
				#endif
				float3 normalizeResult8_g706 = normalize( WorldPosition144 );
				float temp_output_7_0_g708 = AHF_SkyboxFogHeight;
				float lerpResult17_g706 = lerp( saturate( ( ( abs( (normalizeResult8_g706).y ) - temp_output_7_0_g708 ) / ( 0.0 - temp_output_7_0_g708 ) ) ) , 1.0 , AHF_SkyboxFogFill);
				half SkyboxFogHeightMask197 = lerpResult17_g706;
...
/*ASEBEGIN
Version=17008
1927;47;1906;996;3678.873;5162.973;1;True;False
...
Node;AmplifyShaderEditor.FunctionNode;903;-3072,-1152;Inherit;False;Fog Distance;-1;;696;a5f090963b8f9394a984ee752ce42488;0;1;13;FLOAT3;0,0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;908;-3008,384;Inherit;False;Fog Noise;-1;;700;fe51dc291bbca2147aa47de2202288d1;0;2;22;FLOAT3;0,0,0;False;23;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;905;-3072,-384;Inherit;False;Fog Skybox Height;-1;;706;6d26cce249abb074ab51f8986da282cb;0;1;19;FLOAT3;0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;902;-3072,-1536;Inherit;False;Fog Directional;-1;;710;b76195d9ca3254b49ac2428d15088cd6;0;1;15;FLOAT3;0,0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;894;-2880,-3904;Inherit;False;Handle Color Space;-1;;715;f6f44b689bae74d47a0885dbe3018c48;0;1;2;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.FunctionNode;893;-2880,-4096;Inherit;False;Handle Color Space;-1;;716;f6f44b689bae74d47a0885dbe3018c48;0;1;2;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;383;-1152,-4096;Float;False;True;2;;0;1;Hidden/BOXOPHOBIC/Atmospherics/Height Fog Global;0770190933193b94aaa3065e307002fa;True;Unlit;0;0;Unlit;2;True;2;5;False;-1;10;False;-1;0;5;False;-1;10;False;-1;True;0;False;-1;0;False;-1;True;False;True;2;False;-1;True;True;True;True;True;0;False;-1;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;2;False;594;True;7;False;595;True;False;0;False;500;0;False;500;True;2;RenderType=Overlay=RenderType;Queue=Overlay=Queue=0;True;2;0;False;False;False;False;False;False;False;False;False;True;2;LightMode=ForwardBase;PreviewType=Skybox;False;0;;0;0;Standard;1;Vertex Position,InvertActionOnDeselection;1;0;1;True;False;0
...
ASEEND*/
//CHKSM=A6155D703E05356FBD6CF20ED7966005291EB12C